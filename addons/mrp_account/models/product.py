...
class ProductProduct(models.Model):
    ...
    def _compute_average_price(self, qty_invoiced, qty_to_invoice, stock_moves):
        self.ensure_one()
        if stock_moves.product_id == self or stock_moves:
        ...
        for dummy, data in bom_lines:
            ...
            value += bom_line_product._compute_average_price(qty_invoiced * bom_line_qty, qty_to_invoice * bom_line_qty, self.env['stock.move'])
        return value
